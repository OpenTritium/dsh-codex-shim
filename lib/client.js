	...
	factory: (require) => {
		...
		*/
		function CodexToolRow({ toolName, block, inspect, t, imageLoader }) {
			...
			const expandable = diff !== null || image !== void 0 || showRawPanels && (argsRaw !== "" || output !== null);
