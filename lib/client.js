	...
	factory: (require) => {
		...
		*/
		function splitTerminalOutput(text) {
			...
			const body = outputStart !== -1 ? text.slice(outputStart + 9) : text.startsWith("Output:\n") ? text.slice(8) : text;
