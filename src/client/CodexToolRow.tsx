...
import { changedPlanItems, parsePlanPresentation, type PlanItemPresentation, type PlanPresentation, type PlanStatus } from './plan-presentation.ts'
...
function relevantPlanItems(snapshot: ConversationSnapshot, callId: string, current: PlanPresentation): PlanItemPresentation[] {
 ...
 */
export function CodexToolRow({ toolName, block, inspect, t, imageLoader, useSession }: CodexToolRowProps & { imageLoader?: ImageLoader }) {
