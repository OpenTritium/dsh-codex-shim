window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								state.modelsStatus === "ready" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
									...
									children: state.models.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												"enabled",
												"disabled"
											].map((decision) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												type: "button",
		...
		function modelDecision(overrides, provider, model) {
			const override = overrides.find((item) => item.provider === provider && item.model === model);
			return override === void 0 ? "default" : override.enabled ? "enabled" : "disabled";
		}
