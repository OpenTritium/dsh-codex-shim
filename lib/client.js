	...
	factory: (require) => {
		...
		*/
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								state.models.length === 0 && state.modelsStatus !== "loading" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.status,
									children: props.t("settings.modelsEmpty")
		...
		const en = {
			...
			"settings.modelsEmpty": "No model exceptions have been added.",
