window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".JcK1UG_root{flex-direction:column;display:flex}.JcK1UG_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.JcK1UG_root[data-state=running] .JcK1UG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite JcK1UG_dsh-codex-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes JcK1UG_dsh-codex-row-sweep{0%{left:-300px}90%,to{left:100%}}.JcK1UG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.JcK1UG_chevron{color:var(--dsw-alias-label-secondary)}.JcK1UG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.JcK1UG_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.JcK1UG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.JcK1UG_errorSummary{color:var(--dsw-alias-state-error-primary)}.JcK1UG_bodyWrap{grid-template-columns:max-content minmax(0,1fr);row-gap:4px;padding:4px 0 2px 4px;display:grid}.JcK1UG_ioCard{grid-column:1/-1;grid-template-columns:subgrid;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:8px;min-width:0;display:grid;overflow:hidden}.JcK1UG_ioCard[data-stream=stderr]{border-color:color-mix(in srgb, var(--dsw-alias-state-error-primary) 35%, var(--dsw-alias-border-l1))}.JcK1UG_ioCard[data-stream=stderr] .JcK1UG_ioLabel{color:var(--dsw-alias-state-error-primary)}.JcK1UG_streamBody{min-width:0}.JcK1UG_ioLabel{border-right:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);white-space:nowrap;padding:8px;font-size:10px;font-weight:600;line-height:16px}.JcK1UG_ioText{white-space:pre-wrap;overflow-wrap:anywhere;min-width:0;max-height:220px;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:8px 10px;overflow:auto}.JcK1UG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.JcK1UG_imageCard,.JcK1UG_planCard{grid-column:1/-1;grid-template-columns:subgrid;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:8px;min-width:0;display:grid;overflow:hidden}.JcK1UG_imageContent{grid-template-columns:minmax(0,auto) minmax(180px,1fr);align-items:start;gap:12px;min-width:0;padding:8px 10px;display:grid}.JcK1UG_planContent{min-width:0;padding:8px 10px}.JcK1UG_planExplanation,.JcK1UG_planEmpty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:18px}.JcK1UG_planOverview{align-items:center;gap:10px;margin-bottom:8px;display:flex}.JcK1UG_planProgressLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:16px}.JcK1UG_planProgressTrack{background:var(--dsw-alias-border-l2);border-radius:2px;flex:auto;height:4px;display:block;overflow:hidden}.JcK1UG_planProgressValue{border-radius:inherit;background:var(--dsw-alias-state-success-primary);height:100%;transition:width .18s ease-out;display:block}.JcK1UG_planItems{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex;position:relative}.JcK1UG_planItems:before{content:\"\";background:var(--dsw-alias-border-l2);width:1px;position:absolute;top:9px;bottom:9px;left:7px}.JcK1UG_planExplanation+.JcK1UG_planItems{margin-top:8px}.JcK1UG_planItem{min-width:0;color:var(--dsw-alias-label-secondary);grid-template-columns:14px minmax(0,1fr) max-content;align-items:start;gap:8px;font-size:12px;line-height:18px;display:grid}.JcK1UG_planMarker{z-index:1;box-sizing:border-box;border:1px dashed var(--dsw-alias-label-caption);border-radius:50%;width:12px;height:12px;margin:3px 1px;position:relative}.JcK1UG_planItem[data-status=in_progress] .JcK1UG_planMarker{border:3px solid var(--dsw-alias-state-business-primary);border-right-color:#0000;animation:1s linear infinite JcK1UG_dsh-codex-plan-progress}.JcK1UG_planItem[data-status=completed] .JcK1UG_planMarker{border-style:solid;border-color:var(--dsw-alias-state-success-primary);background:var(--dsw-alias-state-success-primary)}.JcK1UG_planItem[data-status=completed] .JcK1UG_planMarker:after{content:\"\";border-bottom:1px solid var(--dsw-alias-bg-base);border-left:1px solid var(--dsw-alias-bg-base);width:4px;height:2px;margin:2px 0 0 2px;display:block;transform:rotate(-45deg)}.JcK1UG_planStep{overflow-wrap:anywhere;min-width:0}.JcK1UG_planItem[data-status=completed] .JcK1UG_planStep{color:var(--dsw-alias-label-tertiary)}.JcK1UG_planStatus{color:var(--dsw-alias-label-caption);white-space:nowrap}.JcK1UG_planItem[data-status=in_progress] .JcK1UG_planStatus{color:var(--dsw-alias-state-business-primary)}.JcK1UG_planItem[data-status=completed] .JcK1UG_planStatus{color:var(--dsw-alias-state-success-primary)}@keyframes JcK1UG_dsh-codex-plan-progress{to{transform:rotate(360deg)}}.JcK1UG_imageMeta{gap:6px;min-width:0;margin:0;padding:4px 0;font-size:12px;line-height:18px;display:grid}.JcK1UG_imageMeta>div{grid-template-columns:max-content minmax(0,1fr);gap:10px;min-width:0;display:grid}.JcK1UG_imageMeta dt{color:var(--dsw-alias-label-caption)}.JcK1UG_imageMeta dd{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.JcK1UG_workdir{text-overflow:ellipsis;white-space:nowrap;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-caption);padding:0 10px 8px;display:block;overflow:hidden}.JcK1UG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:8px;grid-column:1/-1;justify-self:start;align-items:center;gap:4px;margin:0 0 0 4px;padding:2px 8px;font-size:11px;line-height:16px;display:inline-flex}.JcK1UG_inspectButton:hover,.JcK1UG_inspectButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.JcK1UG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (width<=560px){.JcK1UG_imageContent{grid-template-columns:1fr}}@media (prefers-reduced-motion:reduce){.JcK1UG_root[data-state=running] .JcK1UG_row:after{animation:none;display:none}.JcK1UG_planItem[data-status=in_progress] .JcK1UG_planMarker{animation:none}.JcK1UG_planProgressValue{transition:none}}";
		...
		var _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default = {
			...
			"planProgressValue": "JcK1UG_planProgressValue",
			"planProgressTrack": "JcK1UG_planProgressTrack",
			"planProgressLabel": "JcK1UG_planProgressLabel",
			...
			"planExplanation": "JcK1UG_planExplanation",
			"root": "JcK1UG_root",
			"planCard": "JcK1UG_planCard",
			"imageMeta": "JcK1UG_imageMeta",
			"leading": "JcK1UG_leading",
			"imageCard": "JcK1UG_imageCard",
			"planOverview": "JcK1UG_planOverview",
			"dsh-codex-plan-progress": "JcK1UG_dsh-codex-plan-progress",
			"planEmpty": "JcK1UG_planEmpty",
			"planStatus": "JcK1UG_planStatus",
			"planMarker": "JcK1UG_planMarker",
		...
		*/
		function CodexToolRow({ toolName, block, inspect, t, imageLoader }) {
			...
			const completedPlanItems = plan === void 0 ? 0 : planCompletedCount(plan);
						...
						children: [
							...
							diff === null && plan !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									children: [
										plan.explanation === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
											className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planExplanation,
											children: plan.explanation
										}),
										plan.items.length === 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planOverview,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planProgressLabel,
												children: t("row.planProgress", {
													completed: completedPlanItems,
													total: plan.items.length
												})
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planProgressTrack,
												role: "progressbar",
												"aria-label": t("row.planProgress", {
													completed: completedPlanItems,
													total: plan.items.length
												}),
												"aria-valuemin": 0,
												...
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planProgressValue,
													style: { width: `${completedPlanItems / plan.items.length * 100}%` }
												})
											})]
										}),
										plan.items.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
											className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planEmpty,
											children: t("row.planEmpty")
											...
											children: plan.items.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
												...
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planMarker,
														"aria-hidden": true
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFRvb2xSb3cubW9kdWxlLmNzcw_default.planStatus,
														children: planStatusLabel(item.status, t)
													})
												]
											}, `${item.step}:${index}`))
										})
		...
		const zh = {
			...
			"row.planPending": "待处理",
			"row.planProgress": "{completed}/{total} 步骤已完成",
			"row.planEmpty": "暂无计划步骤",
			"row.input": "输入",
			"row.output": "输出",
			"row.inspect": "检查"
		};
		...
		const en = {
			...
			"row.planProgress": "{completed}/{total} steps completed",
			"row.planEmpty": "No plan steps",
			"row.input": "Input",
			"row.output": "Output",
			"row.inspect": "Inspect"
		};
