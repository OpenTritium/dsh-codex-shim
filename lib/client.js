window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/OpenAIWebSettingsCard.tsx
		/** Render the OpenAI Responses hosted Web Search provider settings card. */
		function OpenAIWebSettingsCard(props) {
			const [open, setOpen] = (0, react.useState)(false);
			...
			const saveDisabled = !state.dirty || disabled || Object.values({
				...
				model: state.model,
				searchContextSize: state.searchContextSize
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.header,
					"aria-expanded": open,
					"aria-label": `${props.t(open ? "web.collapse" : "web.expand")}: ${props.t("web.title")}`,
					onClick: () => setOpen((value) => !value),
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.headText,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.name,
								children: props.t("web.title")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.description,
								children: props.t("web.description")
							})]
						}),
						state.dirty ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.pending,
							children: props.t("web.unsaved")
						}) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: `${_opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.chevron} ${open ? _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.chevronOpen : ""}` })
					]
				}), open ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.label,
										children: props.t("web.enabled")
									}),
									state.enabled.overridden ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.reset,
										disabled,
										onClick: () => props.reset("enabled"),
										children: props.t("web.reset")
									}) : null,
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.switch,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											type: "checkbox",
											role: "switch",
											"aria-label": props.t("web.enabled"),
								...
								className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.hint,
								children: props.t("web.enabledHint")
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField, {
							id: "openai-web-base-url",
							label: props.t("web.baseURL"),
							hint: props.t("web.baseURLHint"),
							field: "baseURL",
							state: state.baseURL,
							disabled,
							props
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField, {
							id: "openai-web-credential-ref",
							label: props.t("web.credentialRef"),
							hint: props.t("web.credentialRefHint"),
							field: "credentialRef",
							state: state.credentialRef,
							disabled,
							props
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextField, {
							id: "openai-web-model",
							label: props.t("web.model"),
							hint: props.t("web.modelHint"),
							field: "model",
							state: state.model,
							disabled,
							props
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
										className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.label,
										htmlFor: "openai-web-context-size",
										children: props.t("web.contextSize")
									}), state.searchContextSize.overridden ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.reset,
										disabled,
										onClick: () => props.reset("searchContextSize"),
										children: props.t("web.reset")
									}) : null]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
									id: "openai-web-context-size",
									className: state.searchContextSize.invalid ? _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.inputInvalid : `${_opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.input} ${_opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.selectInput}`,
									value: state.searchContextSize.text,
									disabled,
									onChange: (event) => props.edit("searchContextSize", event.target.value),
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "low",
											children: props.t("web.context.low")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "medium",
											children: props.t("web.context.medium")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "high",
											children: props.t("web.context.high")
										})
									]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.hint,
									children: props.t("web.contextSizeHint")
								})
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									disabled: saveDisabled,
									onClick: props.save,
									children: props.t(state.saving ? "web.saving" : "web.save")
								})
							]
						})
					]
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							className: _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.reset,
							disabled,
							onClick: () => props.reset(field),
							children: props.t("web.reset")
						}) : null]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
						id,
						className: state.invalid ? _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.inputInvalid : _opentritium_css_module_L2hvbWUvdHJpdGl1bS9zcmMvb3BlbnRyaXRpdW0tZHNoLWNvZGV4LXNoaW0vc3JjL2NsaWVudC9Db2RleFNldHRpbmdzQ2FyZC5tb2R1bGUuY3Nz_default.input,
						value: state.text,
						disabled,
		...
		function openAIWebCardFace(controller) {
			return {
		...
		//#endregion
		//#region src/client/openai-web-settings-card-controller.ts
		const OPENAI_WEB_SETTINGS_NS = "opentritium-openai-web";
		const FIELDS = [
			"enabled",
			"baseURL",
			"credentialRef",
		...
		var OpenAIWebSettingsCardController = class {
			scope;
			drafts = /* @__PURE__ */ new Map();
			cleared = /* @__PURE__ */ new Set();
			store;
			...
			async save() {
				...
				this.publish();
				try {
					for (const field of writes) if (this.cleared.has(field) || shouldClear(field, this.drafts.get(field) ?? "")) await this.scope.unset(field);
			...
			field(field) {
				...
				const draft = this.drafts.get(field);
				return {
					text: draft ?? formatValue(field, this.current()[field]),
					overridden: !this.cleared.has(field) && (draft !== void 0 || user !== void 0 && field in user),
					invalid: draft !== void 0 && !validValue(field, draft)
				};
			}
			snapshot() {
				const current = this.scope.getSnapshot();
		...
		function shouldClear(field, value) {
